...
def make_user_aggregator_params(*, fast_interrupt=False) -> LLMUserAggregatorParams:
    vad_analyzer = SileroVADAnalyzer(params=VADParams(start_secs=0.1 if fast_interrupt else 0.2, stop_secs=0.2))
